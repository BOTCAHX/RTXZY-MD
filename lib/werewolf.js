...
async function pagi(conn, x, data) {
    ...
    return await conn.sendMessage(m.chat, { image: { url: thumb1 }, caption: pagii(x), mentions: [m.sender] }, { quoted: m });
}
...
async function voting(conn, x, data) {
    ...
    return await conn.sendMessage(m.chat, { image: { url: thumb2 }, caption: textnya, mentions: [m.sender] }, { quoted: m });
}
...
async function malam(conn, x, data) {
    ...
    if (hasil_vote === 0) {
        ...
        return conn.sendMessage(m.chat, { image: { url: thumb3 }, caption: textnya, mentions: [m.sender] }, { quoted: m })
            .then(() => {
                changeDay(x.room, data);
        ...
        ""
            ...
            return await conn.sendMessage(m.chat, { image: { url: thumb4 }, caption: textnya, mentions: [m.sender] }, { quoted: m })
                .then(() => {
                    changeDay(x.room, data);
                    voteDone(x.room, data);
                    resetVote(x.room, data);
        ...
        hasil_vote.role
            ...
            let ment = [];
            ment.push(hasil_vote.id);
            return await conn.sendMessage(m.chat, { image: { url: thumb4 }, caption: textnya, mentions: [m.sender] }, { quoted: m }).then(() => {
                    changeDay(x.room, data);
                    voteDone(x.room, data);
                    resetVote(x.room, data);
                    clearAllVote(x.room, data);
...
async function win(x, t, conn, data) {
    ...
    if (getWinner(x.room, data).status === false || x.iswin === false) {
        ...
        return await conn.sendMessage(m.chat, { image: { url: thumb5 }, caption: teextnya, mentions: [m.sender] }, { quoted: m });
            .then(() => {
                delete data[x.room];
            });
