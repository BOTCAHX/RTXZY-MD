...
function parseExifJSON (exif) {
    if (!exif) return null
    const str = Buffer.isBuffer(exif) ? exif.toString('utf8') : String(exif)
...
export { imageToWebp, videoToWebp, writeExifImg, writeExifVid, parseExifJSON }
