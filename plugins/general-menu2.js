//Template menu ini bebas ubah sesuka hati
//Tapi dengan syarat kalo eror ya fix sendiri 
...
await conn.send3ButtonImg(m.chat, await (await fetch('https://telegra.ph/file/328f69bd3fa43a1aecb20.jpg')).buffer(),  '*────────[ DASBOARD ]────────*', text, 'List Menu', '.menu', 'Information', '.info', 'Menu Pay', '.pay', m, {  
      quoted: ftroli,  
