...
handler.all = async function (m) {
    ...
    // Debug log agar ID pesan bisa terlihat di terminal
    console.log(`[ANTIBOT DEBUG] Pengirim: ${m.sender}, ID Pesan: ${m.id}`);
    
    let isBotLain = m.id && m.id.startsWith('3EB0') && m.id.length === 22
    if (isBotLain) {
